# InferNode Trademark Policy

The InferNode software is released under the MIT License, which applies to the source code and documentation. However, the trademarks and brand assets described below are **not** covered by the MIT License and are subject to this policy.
...
You **may** use the InferNode name and logo without prior permission for:

- **Nominative reference** — Accurately referring to the InferNode project (e.g., "built with InferNode," "compatible with InferNode," "based on InferNode")
- **Community and educational use** — Discussions, tutorials, reviews, blog posts, conference talks, and academic papers about InferNode
- **Unmodified distribution** — Distributing verbatim copies of the official InferNode release, including the original logo and branding
...
- Use the marks on merchandise or physical goods
- Register the marks (or confusingly similar marks) as trademarks in any jurisdiction

## Modified Versions and Forks

If you distribute a modified version of InferNode:
...
When using the InferNode logo under permitted uses:

- Maintain the original aspect ratio
- Provide adequate clear space around the logo
- Do not place the logo on visually busy backgrounds that reduce legibility
- The preferred presentation is red (#FF0000) on black (#000000) or white on black
- Minimum display size: 32px height for digital use
